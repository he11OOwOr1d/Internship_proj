...
const Body = () => {
  ...
  const fetchData = async () => {
    const data = await fetch(
      "http(s)://thingproxy.freeboard.io/fetch/https://www.swiggy.com/dapi/restaurants/list/v5?lat=22.3008241&lng=73.1733127&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING"
    );
